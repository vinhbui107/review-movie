    ...
    <div>
      <Row>
        <Col md="4" sm="12">
          ...
          <p>
            Thực hành luyện nói tiếng anh mỗi ngày thông qua phụ đề thông ngữ
            thông minh. Giúp trau dồi được khả năng phát âm tiếng anh qua việc
            xem phim có engsub, ngữ điệu cùng phản xạ nói cực kỳ nhanh chóng.
          </p>
        </Col>
        <Col md="4" sm="12">
          ...
          <p>
            ...
            luyện nghe tiếng anh nào làm được.
          </p>
        </Col>
        <Col md="4" sm="12">
