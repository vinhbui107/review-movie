    ...
    <>
      <div style={{ position: "relative" }}>
        <Tabs id="controlled-tab-example" activeKey={key} onSelect={(k) => setKey(k)} className="tab">
          <Tab eventKey="home" title="Phim 1" className="tab__item tab__item-1">
            <div className="tab__caption text-left container">
              <div className="tab__caption__info w-50">
                ...
                <p>
                  Scooby-Doo và the Mystery Inc. hợp sức giải cứu thế giới khỏi tên ác nhân Dick Dastardly. Cùng đón xem
                  bộ phim những cuộc phưu lưu của chú chó scooby doo (2…
                </p>
          ...
          <Tab eventKey="profile" title="Phim 2" className="tab__item tab__item-2">
            <div className="tab__caption text-left container">
          ...
          <Tab eventKey="contact" title="Phim 3" className="tab__item tab__item-3">
            <div className="tab__caption text-left container">
              <div className="tab__item__info w-50">
                <h3>Scoob!</h3>
                <div className="tab__caption__category">
